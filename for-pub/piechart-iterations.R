...
tiff("~/Dropbox/rTwitter/for-pub/figure4.tiff", units="in", width=10, height=5, res=200)
...
pie(c(378,847), cex=2.5,cex.main = 2,  col=c("black","white"),main="Precision",labels=c("31%",""),radius = 0.5, init.angle=350)
...
pie(c(470,13100), cex=2.5,cex.main = 2, col=c("#D3D3D3","white"),main="In Favor of Testing Model",labels=c("3.6%",""),radius = 0.8, init.angle=350)
#segments(x0 = .75,y0 = .27,x1 =10, y1 = -1 )
#segments(0.75,-.18,10,1)
